...
controller.createCustomer = async function(req, res) {
    ...
    try {
        ...
        return res.status(400).send({ error: 'Error creating customer: ' + error.message });
    }
};
...
controller.deleteCustomer = async function(req, res) {
    ...
    try {
        ...
        return res.status(500).send({error: 'Error delete customer: ' + error.message });
    }
}
...
controller.getCustomersByUserId = async function(req, res) {
    ...
    try {
        ...
        return res.status(500).send({ error: 'Error fetching customers: ' + error.message });
    }
};
...
controller.getDataByAfm = async function(req, res) { 
    ...
    try {
      ...
      return res.status(404).send({ error: 'Error fetch data: ' + error.message });
    }
};
